...
# stripe.api_key = "sk_test_51MJJ7ESJgZAJDToetyqUjIXcuVdgQG0rlHDFFdL65jnos8SKKblNyFDboMKHwlCkOTsCfSIbZLjKVD1pxstNzrR0007m4UD8BE"
...
class OrderService:
    ...
    def getOrderById(id: int, db: Session):
        ...
        response = {
            ...
            "orderItems": orderItembyid.orderItems,
            "shippingAddress": shippingByid.shippingAdderss,
        }
